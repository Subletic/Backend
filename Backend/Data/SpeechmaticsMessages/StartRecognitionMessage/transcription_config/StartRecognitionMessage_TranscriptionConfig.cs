...
public class StartRecognitionMessage_TranscriptionConfig
{
    ...
    /// <param name="enable_partials">Whether to send partial transcripts (<c>AddPartialTranscript</c>)</param>
    /// <summary>
    /// Initializes a new instance of the <see cref="StartRecognitionMessage_TranscriptionConfig"/> class.
    /// </summary>
    /// <param name="language">Language model to process audio, usually in ISO language code format. The value must be consistent with the language code used in the API endpoint URL.</param>
    /// <param name="enable_partials">Whether to send partial transcripts (<c>AddPartialTranscript</c>) in addition to the finals (<c>AddTranscriptMessage</c>s).</param>
